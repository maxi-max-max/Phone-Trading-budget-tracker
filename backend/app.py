...
from models import Phone, Budget  # Imports necessary for db.create_all()
import logic
...
def create_app(test_config=None):
    ...
    def add_phone():
        ...
        # Logic: Deduct money immediately
    ...
    def update_phone_state(phone_id):
        ...
        messages = logic.handle_state_change(
            phone, 
            data['state'], 
            data.get('sell_price')
        )
    ...
    def delete_phone(phone_id):
        ...
        # Logic: Refund if bought but never sold
